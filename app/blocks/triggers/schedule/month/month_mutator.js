export default {
  ...
  decompose: function (workspace) {
    ...
    const settingsBlock = workspace.newBlock('month_settings')
    settingsBlock.initSvg()

    const
      inputName = "MONTH",
      defaultType = "all_months",
      outerUnitType = this.type || defaultType,
      // create inner versions
      innerUnitInput = settingsBlock.getInput(`${inputName}_BLOCK`),
  ...
  compose: function (settingsBlock) {
    const newBlock = settingsBlock.getInputTargetBlock(`MONTH_BLOCK`)
