...
export default {
  ...
  HELP_TEXT_BY_PROP: {
    ...
    visibility: {
      values: "1000.0, 28520.77, 33085.52...",
    ...
    moonPhase: {
      values: '"new", "firstQuarter", "waningCrescent"...',
